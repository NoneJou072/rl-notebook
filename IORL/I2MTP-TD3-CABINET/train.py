...
def args():
    ...
    parser.add_argument("--env_name", type=str, default="Cabinet-v1", help="env name")
        ...
        while total_steps < self.max_train_steps:
            ...
            if total_steps >= self.random_steps:
                ...
                if total_steps >= self.random_steps and total_steps % self.args.evaluate_freq == 0:
                    ...
                    writer.add_scalar('success_rate/success_rate_{}_unlock'.format(self.args.env_name),
                                      success_rate_unlock,
                                      global_step=total_steps)
                    writer.add_scalar('success_rate/success_rate_{}_door'.format(self.args.env_name),
                                      success_rate_door,
                                      global_step=total_steps)
    ...
    def evaluate_policy(self):
        ...
        for _ in range(times):
            ...
            while True:
                ...
                obs = deepcopy(obs_)
                if truncated:
                    success_rate_drawer += info['is_unlock_success']
                    break
        ...
        for _ in range(times):
            ...
            while True:
                ...
                if truncated:
                    success_rate_place += info['is_door_success']
                    break
