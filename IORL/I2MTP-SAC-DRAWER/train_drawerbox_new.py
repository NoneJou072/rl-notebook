...
def args():
    ...
    parser.add_argument("--task_list", type=list, default=['reach', 'drawer', 'place'], help="task list")
    ...
    def train(self):
        ...
        while total_steps < self.max_train_steps:
            ...
            for transition in traj_draw.buffer:
                ...
                if reached:
                    break
            self.agent.memory_buffer_pool['drawer'].push(traj_draw)
            self.agent.memory_buffer_pool['reach'].push(traj_reach)
            ...
            for transition in traj_place.buffer:
                ...
                if reached:
                    break
            self.agent.memory_buffer_pool['place'].push(traj_place)
            self.agent.memory_buffer_pool['reach'].push(traj_reach)
